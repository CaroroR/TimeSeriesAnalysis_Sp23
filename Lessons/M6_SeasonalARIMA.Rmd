...
residential_price_trend_diff <- diff(ts_electricity_price[,"Residential"],lag =1, differences=1) #diff done on orig series #differentiate my series once at lag 1. now we need to differentiate at lag 12 and just do it once.
residential_price_both_diff <- diff(residential_price_trend_diff,lag =12, differences=1)

residential_price_seas_diff
residential_price_trend_diff
residential_price_both_diff
