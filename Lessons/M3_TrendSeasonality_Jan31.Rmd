...
```{r}
ts_inflow_data <- ts(inflow_data[,2:(2+nhydro-2)]) #note that we are only transforming columns with inflow data, not the date columns
ts_inflow_data
